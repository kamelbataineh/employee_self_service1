...
String getEmployeesBySubDepartment(String deptId, String subId) => "$Weburl1/employee/employees/$deptId/$subId";


String addEmployeeToSubDepartment =
    "$Weburl1/employee/add-to-sub";
