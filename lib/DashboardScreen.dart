...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void handleCheckIn() {
    if (!isInZone) {
      ScaffoldMessenger.of(context).showSnackBar(
         SnackBar(content: Text("يجب أن تكون داخل منطقة العمل")),
      );
      return;
    }
  ...
  Widget getSelectedPage() {
    switch (selectedIndex) {
      case 0:
        return _homeContent(); // بدل DashboardScreen
      case 1:
      ...
      case 4:
        return  Center(child: Text("البروفايل"));
      default:
        return _homeContent();
    }
  }
  ...
  Widget _buildStats() {
    return GridView.count(
      ...
      mainAxisSpacing: 10,
      children: [
        _statCard("18", "أيام الحضور", Colors.green),
        _statCard("38", "ساعات الأسبوع", Colors.blue),
        _statCard("24", "مهام", Colors.purple),
        _statCard("92%", "الأداء", Colors.orange),
      ],
    );
  }
